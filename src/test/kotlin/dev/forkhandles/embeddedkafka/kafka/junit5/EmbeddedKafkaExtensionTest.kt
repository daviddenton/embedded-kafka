...
import dev.forkhandles.embedded.kafka.junit5.EmbeddedKafkaAddress
import dev.forkhandles.embedded.kafka.junit5.EmbeddedKafkaExtension
import dev.forkhandles.embedded.kafka.junit5.EmbeddedKafkaProducer
import dev.forkhandles.embedded.kafka.junit5.EmbeddedKafkaProperties
import dev.forkhandles.embedded.kafka.junit5.EmbeddedKafkaTopics
...
class EmbeddedKafkaExtensionTest {
    ...
    val brokerProperties
        get() = mapOf("auto.create.topics.enable" to false)

    @get:EmbeddedKafkaTopics
    val topics get() = listOf("test-topic")
